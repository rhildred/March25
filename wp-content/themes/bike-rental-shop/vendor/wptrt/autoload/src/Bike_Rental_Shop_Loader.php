...
class Bike_Rental_Shop_Loader {
	 ...
	 * @return void
	 */
	public function bike_rental_shop_add( $prefix, $paths ) {
	 ...
	 * @return void
	 */
	public function bike_rental_shop_remove( $prefix, $path = '' ) {
	 ...
	 * @return bool
	 */
	public function bike_rental_shop_has( $prefix, $path = '' ) {
		if ( $path ) {
	 ...
	 * @return void
	 */
	public function bike_rental_shop_register() {

		if ( $this->loaders ) {

			spl_autoload_register( function( $class ) {

				$this->bike_rental_shop_load( $class );
			}, true, true );
		}
	}
	/**
	 ...
	 * @return void
	 */
	protected function bike_rental_shop_load( $class ) {
